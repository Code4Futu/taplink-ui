...
interface IEditDetailProduct {
	handleDecEditTab: () => void;
}
export const EditDetailProduct: React.FC<IEditDetailProduct> = ({
	handleDecEditTab,
}) => {
	return (
		<>
